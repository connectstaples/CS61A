...
def floor_div(args):
    ...
    """
    "*** YOUR CODE HERE ***"
    # dividend = eval(args.first)
    # divisor = eval(args.rest)
    # return dividend // divisor 
    first_val = args.first
    while args is not nil and args.rest is not nil:
        first_val = first_val // args.rest.first
        args = args.rest
    return first_val
...
def eval_and(expressions):
    ...
    """
    "*** YOUR CODE HERE ***"
    # first_val = expressions.first

    # while expressions.first is not nil and expressions.rest is not nil:
    #     if first_val is scheme_f: 
    #         return False
    #     elif expressions.rest.first.rest is scheme_f: 
    #         return False 
    #     else: 
    #         return True or eval()
    while expressions is not nil and expressions.rest is not nil:
        if calc_eval(expressions.first) is scheme_f:
            return expressions.first # return first element because falsy 
        expressions = expressions.rest # update expressions
    return expressions == nil or calc_eval(expressions.first) # depending on which is true 
...
def eval_define(expressions):
    ...
    """
    "*** YOUR CODE HERE ***"
    # symbol =  expressions.first.rest.first
